    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-white flex flex-col">
            ...
            <div class="p-6 border-t">
                <a href="kas_harian.php?action=logout" class="w-full text-center bg-red-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-red-700 transition">
                    Keluar
                </a>
            </div>
        </aside>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 h-full flex flex-col">
                ...
                <div class="flex-grow overflow-y-auto">
                    <table class="w-full text-center text-sm">
                        ...
                        <tbody>
                            <?php for ($i = 0; $i < 20; $i++): // Loop untuk 20 baris kosong ?>
                            <tr>
